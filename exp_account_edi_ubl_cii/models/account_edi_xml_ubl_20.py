...
class AccountEdiXmlUBL20(models.AbstractModel):
    ...
    def _export_invoice_vals(self, invoice):
        ...
        vals = {
            ...
            'AddressType_template': 'exp_account_edi_ubl_cii.ubl_20_AddressType',
            'ContactType_template': 'exp_account_edi_ubl_cii.ubl_20_ContactType',
            'PartyType_template': 'exp_account_edi_ubl_cii.ubl_20_PartyType',
            'PaymentMeansType_template': 'exp_account_edi_ubl_cii.ubl_20_PaymentMeansType',
            'TaxCategoryType_template': 'exp_account_edi_ubl_cii.ubl_20_TaxCategoryType',
            'TaxTotalType_template': 'exp_account_edi_ubl_cii.ubl_20_TaxTotalType',
            'AllowanceChargeType_template': 'exp_account_edi_ubl_cii.ubl_20_AllowanceChargeType',
            'InvoiceLineType_template': 'exp_account_edi_ubl_cii.ubl_20_InvoiceLineType',
            'InvoiceType_template': 'exp_account_edi_ubl_cii.ubl_20_InvoiceType',
        ...
        if invoice.move_type == 'out_invoice':
            vals['main_template'] = 'exp_account_edi_ubl_cii.ubl_20_Invoice'
            vals['vals']['invoice_type_code'] = 380
        else:
            vals['main_template'] = 'exp_account_edi_ubl_cii.ubl_20_CreditNote'
