...
from odoo.addons.exp_account_edi_ubl_cii.models.account_edi_common import COUNTRY_EAS
...
class AccountEdiFormat(models.Model):
    ...
    def _prepare_invoice_report(self, pdf_writer, edi_document):
        ...
        if not pdf_writer.is_pdfa and str2bool(
            ...
            metadata_template = self.env.ref('exp_account_edi_ubl_cii.account_invoice_pdfa_3_facturx_metadata',
                                             raise_if_not_found=False)
            if metadata_template:
                content = self.env['ir.qweb']._render('exp_account_edi_ubl_cii.account_invoice_pdfa_3_facturx_metadata', {
