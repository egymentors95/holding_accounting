...
class AccountChartTemplate(models.Model):
    ...
    def _prepare_all_journals(self, acc_template_ref, company, journals_dict=None):
        ...
        if self == self.env.ref('exp_l10n_sa.sa_chart_template_standard'):
    ...
    def _load_template(self, company, code_digits=None, account_ref=None, taxes_ref=None):
        ...
        if self == self.env.ref('exp_l10n_sa.sa_chart_template_standard'):
            ...
            if ifrs_journal_id:
                ifrs_account_ids = [self.env.ref('exp_l10n_sa.sa_account_100101').id,
                                    self.env.ref('exp_l10n_sa.sa_account_100102').id,
                                    self.env.ref('exp_l10n_sa.sa_account_400070').id]
            ...
            if zakat_journal_id:
                zakat_account_ids = [self.env.ref('exp_l10n_sa.sa_account_201019').id,
                                    self.env.ref('exp_l10n_sa.sa_account_400072').id]
