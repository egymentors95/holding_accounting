...
class AccountMove(models.Model):
    ...
    authorized_person_id = fields.Many2one(related='partner_id.authorized_person_id', readonly=False, store=True,
                                           string='المفوض بالاستلام', )
    authorized_signature = fields.Binary(related='partner_id.signature',
                                         readonly=False, store=True,
                                         help='توقيع المفوض بالاستلام',
                                         string='التوقيع المفوض بالاستلام', )
    journal_type_id = fields.Many2one('account.journal.type', readonly=False, store=True,
                                      string='Journal Type',
                                      help="The type of the journal, used to determine the type of the move. "
                                           "This is used to determine the type of the move, e.g. 'sale', 'purchase', 'general', etc.")
...
class AccountMoveLine(models.Model):
    ...
    journal_type = fields.Char(related='move_id.journal_type_id.name', readonly=True, store=True,)
