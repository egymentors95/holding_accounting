...
from odoo.addons.exp_account_edi.tests.common import AccountEdiTestCommon, _mocked_post_two_steps, _generate_mocked_needs_web_services, _mocked_cancel_failed, _generate_mocked_support_batching
...
class TestAccountEdi(AccountEdiTestCommon, CronMixinCase):
    ...
    def test_prepare_jobs(self):
        ...
        with patch('odoo.addons.exp_account_edi.models.account_edi_format.AccountEdiFormat._support_batching', return_value=True):
            to_process = edi_docs._prepare_jobs()
    ...
    @patch('odoo.addons.exp_account_edi.models.account_edi_format.AccountEdiFormat._post_invoice_edi', return_value={})
    def test_warning_is_retried(self, patched):
        with patch('odoo.addons.exp_account_edi.models.account_edi_format.AccountEdiFormat._needs_web_services',
    ...
    def test_cron_triggers(self):
        with self.capture_triggers('exp_account_edi.ir_cron_edi_network') as capt, \
    ...
    def test_cron_self_trigger(self):
        ...
        edi_cron = self.env.ref('exp_account_edi.ir_cron_edi_network')
        ...
        with self.capture_triggers('exp_account_edi.ir_cron_edi_network') as capt, \
            ...
            self.env.ref('exp_account_edi.ir_cron_edi_network').method_direct_trigger()
