        ...
        for col_pos, column in report_data["columns"].items():
            ...
            if cell_type == "string":
                ...
                if (
                    ...
                    cell_format = report_data["formats"]["format_amount_bold"]
                elif line_dict.get("total", False):
                    cell_format = report_data["formats"]["format_header_amount"]
                else:
                    cell_format = report_data["formats"]["format_amount"]
                report_data["sheet"].write_number(
                    report_data["row_pos"], col_pos, float(value), cell_format
                ...
                if column["field"] == 'initial_debit':
                    value = line_dict.get('initial_balance')[0]
                elif column["field"] == 'initial_credit':
                    value = line_dict.get('initial_balance')[1]
                else:
                    value = line_dict.get('initial_balance')[2]
                if (
                        line_dict.get("account_group_id", False)
                        and line_dict["account_group_id"]
                ):
                ...
                if column["field"] == 'ending_debit':
                    value = line_dict.get('ending_balance')[0]
                elif column["field"] == 'ending_credit':
                    value = line_dict.get('ending_balance')[1]
                else:
                    value = line_dict.get('ending_balance')[2]
                if (
                        line_dict.get("account_group_id", False)
                        and line_dict["account_group_id"]
                ):
