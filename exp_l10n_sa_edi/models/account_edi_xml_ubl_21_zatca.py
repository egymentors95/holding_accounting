...
class AccountEdiXmlUBL21Zatca(models.AbstractModel):
    ...
    def _l10n_sa_generate_invoice_xml_sha(self, xml_content):
        ...
        def _transform_and_canonicalize_xml(content):
            ...
            invoice_xsl = etree.parse(get_module_resource('exp_l10n_sa_edi', 'data', 'pre-hash_invoice.xsl'))
    ...
    def _export_invoice_vals(self, invoice):
        ...
        vals.update({
            'main_template': 'exp_account_edi_ubl_cii.ubl_20_Invoice',
            'InvoiceType_template': 'exp_l10n_sa_edi.ubl_21_InvoiceType_zatca',
            'InvoiceLineType_template': 'exp_l10n_sa_edi.ubl_21_InvoiceLineType_zatca',
            'AddressType_template': 'exp_l10n_sa_edi.ubl_21_AddressType_zatca',
            'PartyType_template': 'exp_l10n_sa_edi.ubl_21_PartyType_zatca',
            'TaxTotalType_template': 'exp_l10n_sa_edi.ubl_21_TaxTotalType_zatca',
            'PaymentMeansType_template': 'exp_l10n_sa_edi.ubl_21_PaymentMeansType_zatca',
        })
