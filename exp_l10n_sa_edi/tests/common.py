...
from odoo.addons.exp_account_edi.tests.common import AccountEdiTestCommon
...
class TestSaEdiCommon(AccountEdiTestCommon):
    ...
    @classmethod
    def setUpClass(cls, chart_template_ref='exp_l10n_sa.sa_chart_template_standard', edi_format_ref='exp_l10n_sa_edi.edi_sa_zatca'):
